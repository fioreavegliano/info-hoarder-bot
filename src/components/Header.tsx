      ...
      <div className="bg-foreground text-primary-foreground py-2">
        <div className="container flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-primary-foreground/70 hover:text-primary transition-colors">
          ...
          <a
            href="tel:+17273080631"
            className="flex items-center gap-2 border border-primary-foreground/30 rounded-full px-5 py-1.5 text-sm hover:bg-primary-foreground/10 transition-colors"
          >
            <Phone size={14} />
            Call Us: +1 727 308-0631
          </a>
        </div>
      </div>
      ...
      <header className="sticky top-0 z-50 bg-background/95 backdrop-blur-sm shadow-sm">
        <div className="container flex items-center justify-between h-20">
          <a href="#home" onClick={() => scrollTo("#home")} className="flex items-center">
            <img src="/images/logo.png" alt="Maquinaria CNC LLC" className="h-14" />
          </a>
